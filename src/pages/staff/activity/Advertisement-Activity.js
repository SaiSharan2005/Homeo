...
const AdvertisementActivitySearch = () => {
  ...
  // Filter logs based on keyword and userType === "staff"
  const filterLogs = () => {
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <div className="bg-white rounded-md shadow p-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-4">Advertisement Activity Log</h2>
            ...
            <table className="min-w-full bg-white border border-gray-200 rounded-lg shadow">
              <thead>
                <tr className="bg-gray-100 text-gray-600 border-b">
                  ...
                  {/* You may omit the User Type column if not needed */}
