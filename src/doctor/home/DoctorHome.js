...
//         const response = await fetch(
//           `http://localhost:8080/schedule/doctor/${doctor.doctorId}/date/${formatDate(selectedDate)}`
//         );
//         const data = await response.json();
...
//     try {
//       const response = await fetch(
//         `http://localhost:8080/create-appointment-slots/date/${formatDate(selectedDate)}`,
//         {
//           method: "POST",
//           headers: {
...
//               </p>
//               <button  onClick={()=>navigator("/doctor/history")}className="bg-green-600 text-white px-6 py-3 rounded-lg hover:bg-green-700">
...
//         </main>
//       </div>
//       <div className="flex justify-around space-x-10 mx-auto my-8 md:w-[80vw]">
//         <div className="">
...
//         <div className="w-2/3 bg-white rounded-lg shadow-md p-4 text-center">
...
//             </>
//           )}
//           {selectedDate && <Schedules date={selectedDate} />}
//         </div>
//       </div>
